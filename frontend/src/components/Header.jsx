                ...
                {showAdminMenu && (
                  <div className="absolute right-0 mt-2 w-64 bg-white border border-slate-200 rounded-2xl shadow-2xl z-50 p-2 space-y-1.5 animate-scale-in">
                    <div className="px-3 py-2 border-b border-slate-100">
                      <p className="text-[10px] font-bold text-slate-400 uppercase tracking-wider">Switch Active Admin Account</p>
                    </div>

                    <button
                      type="button"
                      onClick={() => {
                        loginUser('teja.adusumilli', '', 'Admin');
                        setShowAdminMenu(false);
                    ...
                    >
                      <div className="flex items-center gap-2.5">
                        ...
                        <div className="text-left">
                          <p className="text-xs leading-none font-bold">Teja Adusumilli</p>
                          <p className="text-[9px] text-slate-400 mt-1">teja.adusumilli@company.com</p>
                        </div>
                      </div>
                      {currentUser.name.includes('Teja') && (
                    ...
                    >
                      <div className="flex items-center gap-2.5">
                        ...
                        <div className="text-left">
                          <p className="text-xs leading-none font-bold">Rakesh Reddy</p>
                          <p className="text-[9px] text-slate-400 mt-1">rakesh.reddy@company.com</p>
                        </div>
                      </div>
                      {currentUser.name.includes('Rakesh') && (
                        <span className="h-2 w-2 rounded-full bg-blue-600" />
                    ...
                    <div className="pt-1 border-t border-slate-100">
                      <button
                        ...
                        className="w-full p-2 rounded-xl text-left text-xs font-bold text-rose-600 hover:bg-rose-50 flex items-center gap-2 transition-all cursor-pointer"
                      >
