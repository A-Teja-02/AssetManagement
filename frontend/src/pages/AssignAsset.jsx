...
const AssignAsset = () => {
  ...
  const handleSubmit = (e) => {
    ...
    alert(`Successfully assigned ${selectedAssetIds.length} assets to ${currentEmp.name}!`);
    setSelectedAssetIds([]);
    setRemarks('');
            ...
            {currentEmp && (
              <div className="p-4 bg-blue-50/50 border border-blue-100 rounded-2xl flex gap-3 text-xs">
                <img 
                  ...
                  alt={currentEmp.name} 
                  className="h-14 w-14 rounded-xl object-cover shrink-0 border border-blue-200" 
                />
                ...
                return (
                  <tr key={index} className="hover:bg-slate-50/50">
                    <td className="py-4 pr-4 font-bold">
                      {emp ? (
                        <div className="flex items-center gap-2">
                          <img src={emp.avatar} className="h-6 w-6 rounded-full object-cover shrink-0" alt="" />
                    ...
                    <td className="py-4 pl-4 text-right">
                      <button 
                        onClick={() => alert(`Details: ${log.details}`)}
