                    ...
                    >
                      ...
                      <td className="py-4 px-4 font-bold text-slate-800">
                        <div className="flex items-center gap-3">
                          <img src={emp.avatar} alt={emp.name} className="h-8 w-8 rounded-xl object-cover shrink-0 ring-2 ring-slate-100" />
                          <span>{emp.name}</span>
                        </div>
                      </td>
                      ...
                      <td className="py-4 pl-4 text-right">
                        <div className="flex items-center justify-end gap-2.5">
                          ...
                          <button 
                            onClick={(e) => {
                              e.stopPropagation();
                              if (confirm(`Delete employee record ${emp.name}?`)) {
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="relative bg-white border border-slate-200 w-full max-w-lg rounded-3xl shadow-2xl overflow-hidden p-6 z-10 flex flex-col">
            ...
            <div className="flex items-center gap-4 border-b border-slate-100 pb-5 mb-5">
              <img src={selectedEmployee?.avatar} alt={selectedEmployee?.name} className="h-16 w-16 object-cover rounded-2xl border border-slate-100 shrink-0" />
              <div>
